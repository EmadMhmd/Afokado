import {BOOK_NOTIFICATIONS_OPNED , APP_NOTIFICATIONS_OPNED ,LAWYER_NOTIFICATIONS_FETCHING_SUCCESS ,TASK_NOTIFICATIONS_OPNED} from '../actions/actionTypes'
const initState={
    booksCount : 0,
    BookDeletesCount:0,
    applicationsCount:0,
